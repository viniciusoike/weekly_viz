...
subtitle <- "Only Santa Catarina (SC), Amapa (AP), and Roraima (RR) are in a better situation.\nNortheast region suffered the most with Pernambuco, PE (5.6 p.p. rise),\nAlagoas, AL (4.2 p.p. rise), and Ceara, CE (4.1 p.p. rise).\nBrazil's average unemployment is 14.1% (2.1 p.p. rise)."
